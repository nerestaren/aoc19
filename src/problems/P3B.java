 ...
 * @author Antoni
 */
public class P3B extends util.Problem {
        ...
        try {
            ...
            for (Point a : cables.get(0)) {
                ...
                for (Point b : cables.get(1)) {
                    if (a.equals(b)) {
                        if (found == null || stepsA + stepsB < minSteps) {
                            found = a;
            ...
            System.out.println("Intersecció: " + found + ", amb passes = " + minSteps);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
