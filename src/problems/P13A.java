 ...
 * @author Antoni
 */
public class P13A extends util.Problem {
        ...
        try {
            ...
            while (!computer.hasFinished()) {
                try {
                    ...
                    if (display.containsKey(position)) {
                        System.out.println(position + ": " + display.get(position) + " -> " + id);
                    }
            ...
            System.out.println("Total block: " + total);
